...
`
  ...
  const handleRegisterCourse = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        console.log("Course registered successfully by backend API!");
      }
    } catch (err) {
    ...
    const newCourse = {
      ...
      progress: 0,
      hoursSpent: parseFloat(newPrevStudyHours) || 0.0,
      color: randomColor,
      syllabusName: syllabusFilename,
      prevExamScore: parseFloat(newPrevScore) || 0.0,
                  ...
                  <div className="course-sidebar">
                    ...
                    <div className="course-sidebar-content font-sans text-xs flex flex-col gap-4">
                      ...
                      <p className="leading-relaxed">
                        💡 <strong>Strategy:</strong> Focus on core topics listed under your syllabus milestones. Close the gap to your target grade by logging regular study focus hours.
                      </p>
